...
cells.use = colnames(bipolar_dge)[Matrix::colSums(bipolar_dge[mt.genes, ]) / Matrix::colSums(bipolar_dge) < 0.1]
...
m = m[rowSums(m)>0,]
com = ComBat(m2, batchid, prior.plots=FALSE, par.prior=TRUE)
