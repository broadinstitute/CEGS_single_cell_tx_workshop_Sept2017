...
MIN_LOGFOLD_CHANGE = log2(2) # set to minimum required average fold change in gene expression.
...
```{r}
top10 <- all.markers.sortedByPval %>% group_by(cluster) %>% top_n(10, avg_diff)
